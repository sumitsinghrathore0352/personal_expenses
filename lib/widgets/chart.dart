...
List<Map<String ,Object>> get groupedTransctionValue{
   return List.generate(7, (index) {
     ...
     return  {
       ...
       double get totalSpending{
            return groupedTransctionValue.fold(0.0, (sum, item){
              return sum +( item["amount"] as double) ;
            });
}
  @override
  Widget build(BuildContext context) {
  print(groupedTransctionValue);
    return Card(
      elevation: 6,
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...groupedTransctionValue.map((data) {
              return Flexible(
                fit:FlexFit.tight,
